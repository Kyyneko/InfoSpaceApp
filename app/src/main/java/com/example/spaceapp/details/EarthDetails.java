...
public class EarthDetails extends AppCompatActivity implements View.OnClickListener {

    ImageView earth, saturnus, mars, neptunus, merkurius, uranus, jupiter, venus, btn_detail;

    // ArrayList untuk menyimpan data planet
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.earth) {
            ...
            // Menambahkan data planet Jupiter ke ArrayList planets
