...
public class Venus extends AppCompatActivity implements View.OnClickListener {

    private TextView content, planetName;
    private ImageView planetImg, arrow_down;
    private ImageView neptunus, jupiter, merkurius, mars, saturnus, uranus, earth;
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.neptunus) {
            ...
            intent = new Intent(this, VenusDetails.class);
        }
