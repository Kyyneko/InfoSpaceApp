...
public class Neptunus extends AppCompatActivity implements View.OnClickListener {

    private TextView content, planetName;
    private ImageView planetImg, arrow_down;
    private ImageView saturnus, jupiter, merkurius, mars, uranus, venus, earth;
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.saturnus) {
            ...
            intent = new Intent(this, NeptunusDetails.class);
        }
